...
<head>
  ...
  <meta name="description" content="Read the {{ config('app.name') }} Terms of Service. Understand your rights and obligations as a Business or Worker on our independent contractor marketplace." />
  ...
  <section class="cta-section">
    <div style="max-width:56rem;margin:0 auto;">
      ...
      <p style="font-size:1.125rem;line-height:1.75;max-width:42rem;opacity:0.85;">
        Effective Date: February 21, 2026. Please read these Terms carefully before using the {{ config('app.name') }} platform.
      </p>
    </div>
  </section>
  ...
  <section class="section">
    <div style="max-width:52rem;margin:0 auto;">
      ...
      <p class="text-muted" style="line-height:1.75;margin-bottom:2.5rem;">
        These Terms of Service ("Terms") govern your access to and use of the {{ config('app.name') }} platform, website, and related services (collectively, the "Platform") operated by {{ config('app.name') }}, LLC ("{{ config('app.name') }}," "we," "us," or "our"). By creating an account or using the Platform in any way, you agree to be bound by these Terms. If you do not agree, do not use the Platform.
      </p>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <ul class="text-muted" style="line-height:1.75;padding-left:1.5rem;display:flex;flex-direction:column;gap:0.5rem;">
          <li><strong>Platform</strong> — The {{ config('app.name') }} website, mobile applications, and all associated technology services.</li>
          ...
          <li><strong>Engagement</strong> — The contractual relationship between a Business and a Worker for a specific Shift, formed independent of {{ config('app.name') }}.</li>
          <li><strong>Service Fees</strong> — Fees charged by {{ config('app.name') }} to Businesses and/or Workers for access to and use of the Platform.</li>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }} is a technology marketplace only. {{ config('app.name') }} is NOT an employer, staffing agency, labor broker, or joint employer of any Worker or Business user. {{ config('app.name') }} does not supervise, direct, or control the work performed by Workers on any Shift.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          The direct legal and contractual relationship for any Shift or Engagement exists exclusively between the Business and the Worker. {{ config('app.name') }} facilitates introductions and provides payment infrastructure but is not a party to any Engagement. All decisions regarding hiring, supervision, pay rates, and work conditions are made solely between Businesses and Workers.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;">
          {{ config('app.name') }} reserves the right to verify your identity and, for Workers, your legal authorization to work in the United States. Providing false information is grounds for immediate account termination. Workers must be legally authorized to work in the United States under applicable federal immigration law.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Businesses authorize {{ config('app.name') }} to charge applicable Service Fees at the time a Shift is confirmed. Businesses must maintain a valid payment method on file. Cancellation fees apply as follows: cancellations within 24 hours of Shift start time are subject to the full Service Fee; cancellations between 24 and 72 hours prior to Shift start time are subject to a 50% Service Fee.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          Payment disputes must be submitted to {{ config('app.name') }} within 5 business days of the Shift completion date. {{ config('app.name') }}'s determination regarding payment disputes is final. By registering, Businesses authorize {{ config('app.name') }} to automatically charge the payment method on file for all fees incurred.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <div style="background-color:var(--accent-a10);border-left:4px solid var(--accent);padding:1.25rem 1.5rem;border-radius:0.5rem;margin-bottom:1.25rem;">
          ...
          <p class="text-muted" style="line-height:1.75;font-size:0.9375rem;">
            By posting a Shift and engaging a Worker through the Platform, each Business explicitly acknowledges and agrees that all Workers engaged through {{ config('app.name') }} are independent contractors, not employees of the Business or {{ config('app.name') }}.
          </p>
        </div>
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Each Business agrees to indemnify, defend, and hold harmless {{ config('app.name') }} and its officers, directors, employees, and agents from and against any and all claims, losses, penalties, fines, assessments, damages, and costs (including reasonable attorneys' fees) arising from or related to: (a) any misclassification of a Worker as an independent contractor; (b) any determination by a government agency or court that a Worker is an employee of the Business or a joint employee of the Business and {{ config('app.name') }}; or (c) any failure by the Business to comply with applicable wage, hour, benefits, or tax withholding obligations.
        </p>
        <p class="text-muted" style="line-height:1.75;">
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Workers who use the {{ config('app.name') }} Platform do so as independent contractors. Workers are not employees of {{ config('app.name') }} or of any Business that engages them through the Platform. Accordingly, Workers are not entitled to and will not receive any employee benefits from {{ config('app.name') }} or from any Business, including but not limited to: health insurance, dental or vision coverage, workers' compensation insurance, unemployment insurance, paid time off, retirement or pension benefits, or any other employee benefit.
        </p>
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Workers retain the right to perform services for multiple clients, including direct competitors of {{ config('app.name') }} and of any Business that engages them. {{ config('app.name') }} does not guarantee any minimum amount of work, Shifts, or income to any Worker. The availability of Shifts depends on market conditions and Business demand, which {{ config('app.name') }} does not control.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          Nothing in these Terms, nor the use of the terms "Worker," "independent contractor," or similar labels, creates or is intended to create an employment relationship, agency relationship, partnership, or joint venture between {{ config('app.name') }} and any Worker.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Workers are solely responsible for all federal, state, and local income taxes on earnings received through the Platform. {{ config('app.name') }} does not withhold any taxes from payments made to Workers. Workers who earn $600 or more in a calendar year through the Platform will receive IRS Form 1099-NEC. Workers are responsible for reporting all earnings to the IRS regardless of whether a 1099-NEC is issued.
        </p>
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          As independent contractors, Workers are subject to self-employment tax (currently 15.3% on net self-employment earnings) covering Social Security and Medicare. Workers are generally required to make quarterly estimated tax payments to the IRS using Form 1040-ES to avoid underpayment penalties. {{ config('app.name') }} strongly encourages Workers to set aside a portion of each payment for tax obligations.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          Workers operating through a business entity (e.g., LLC or sole proprietorship) must provide a valid IRS Form W-9 before receiving payment. {{ config('app.name') }} is not responsible for any tax penalties, interest, or assessments incurred by Workers arising from their failure to comply with applicable tax law.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;">
          Workers seeking to fill Shifts requiring specific licenses, certifications, or professional credentials must provide accurate documentation of those credentials. {{ config('app.name') }} reserves the right to verify all credentials and to deny or revoke access to Shifts where credentials cannot be verified.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;">
          Workers must not report to any Shift under the influence of alcohol or controlled substances. Workers must not represent themselves as an employee of the Business or of {{ config('app.name') }} to any third party. All conduct at a Business's worksite is the sole responsibility of the Worker.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;">
          {{ config('app.name') }} strongly recommends that both Workers and Businesses consult with qualified legal counsel regarding their classification rights and obligations under applicable law.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;">
          Workers are not covered by any workers' compensation insurance provided by {{ config('app.name') }}. Workers are strongly encouraged to obtain occupational accident insurance or other coverage appropriate to their activities as independent contractors. {{ config('app.name') }} is not responsible for any injuries, illnesses, or damages suffered by Workers in the course of performing Shifts.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }} owns all right, title, and interest in and to the Platform, including all software, designs, trademarks, service marks, logos, text, and other content created by {{ config('app.name') }} (collectively, "{{ config('app.name') }} IP"). Nothing in these Terms transfers any ownership of {{ config('app.name') }} IP to you.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          Subject to your compliance with these Terms, {{ config('app.name') }} grants you a limited, non-exclusive, non-transferable, revocable license to access and use the Platform solely for its intended purpose. You may not copy, scrape, reverse engineer, decompile, modify, or create derivative works based on any portion of the Platform or {{ config('app.name') }} IP without prior written consent.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Your use of the Platform is also governed by {{ config('app.name') }}'s Privacy Policy, which is incorporated into these Terms by reference. The Privacy Policy explains how we collect, use, and share your personal information.
        </p>
        <p class="text-muted" style="line-height:1.75;">
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          THE PLATFORM IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. {{ strtoupper(config('app.name')) }} DOES NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          {{ strtoupper(config('app.name')) }} MAKES NO WARRANTY REGARDING THE SKILL, QUALIFICATIONS, OR SUITABILITY OF ANY WORKER, NOR REGARDING THE LEGITIMACY, SAFETY OF WORKSITE, OR ACCURACY OF SHIFT POSTINGS OF ANY BUSINESS. {{ strtoupper(config('app.name')) }} DOES NOT SCREEN OR VERIFY ALL INFORMATION PROVIDED BY USERS AND ACCEPTS NO RESPONSIBILITY FOR THE ACCURACY OF USER-SUBMITTED CONTENT.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, {{ strtoupper(config('app.name')) }}'S TOTAL LIABILITY TO YOU FOR ANY CLAIMS ARISING OUT OF OR RELATED TO THESE TERMS OR YOUR USE OF THE PLATFORM SHALL NOT EXCEED THE TOTAL AMOUNT OF SERVICE FEES PAID TO OR RECEIVED FROM {{ strtoupper(config('app.name')) }} BY YOU IN THE SIX (6) MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          IN NO EVENT SHALL {{ strtoupper(config('app.name')) }} BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES, INCLUDING LOST PROFITS, LOST DATA, BUSINESS INTERRUPTION, OR PERSONAL INJURY, EVEN IF {{ strtoupper(config('app.name')) }} HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. {{ strtoupper(config('app.name')) }} IS NOT LIABLE FOR ANY CONDUCT, ACTIONS, OR OMISSIONS OF ANY WORKER AT A BUSINESS'S WORKSITE, OR FOR THE CONDUCT OF ANY BUSINESS TOWARD ANY WORKER.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }} will pay all AAA filing fees and arbitrator compensation for any arbitration you initiate in good faith. The arbitrator may award the same remedies as a court, including injunctive or declaratory relief on an individual basis.
        </p>
        <p class="text-muted" style="line-height:1.75;">
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }} may update or modify these Terms at any time. We will notify you of material changes by email or by posting a notice on the Platform. Your continued use of the Platform after the effective date of any updated Terms constitutes your acceptance of the changes.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          For material changes that significantly affect your rights or obligations, {{ config('app.name') }} may require your affirmative re-acceptance of the updated Terms before you may continue using the Platform.
        </p>
      </div>
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }} may suspend or terminate your access to the Platform at any time, with or without cause, and with or without notice. Accounts found to have engaged in fraud, safety violations, or serious breaches of these Terms may be terminated immediately and without prior notice.
        </p>
        <p class="text-muted" style="line-height:1.75;">
      ...
      <div style="margin-bottom:2.5rem;">
        ...
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          These Terms, together with the Privacy Policy and any other policies incorporated by reference, constitute the entire agreement between you and {{ config('app.name') }} regarding your use of the Platform and supersede all prior agreements and understandings. If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions will remain in full force and effect.
        </p>
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          {{ config('app.name') }}'s failure to enforce any right or provision of these Terms does not constitute a waiver of that right or provision. You may not assign your rights or obligations under these Terms without {{ config('app.name') }}'s prior written consent. {{ config('app.name') }} may assign its rights and obligations freely. Neither party will be liable for delays or failures in performance resulting from circumstances beyond its reasonable control (force majeure).
        </p>
        <p class="text-muted" style="line-height:1.75;margin-bottom:1rem;">
          Nothing in these Terms creates a joint venture, partnership, employment relationship, or agency relationship between {{ config('app.name') }} and any user.
        </p>
        <p class="text-muted" style="line-height:1.75;">
          To contact {{ config('app.name') }} regarding these Terms or to submit a notice required under these Terms, please email us at <strong>legal@shiftready.com</strong> or write to: {{ config('app.name') }}, LLC, San Antonio, Texas.
        </p>
      </div>
